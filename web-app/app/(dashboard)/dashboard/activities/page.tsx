  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-1.5 shadow-sm flex gap-1 overflow-x-auto">
        ...
        <a href="/dashboard/tasks" className="px-5 py-3 rounded-2xl text-sm font-bold text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-all whitespace-nowrap">Tasks</a>
