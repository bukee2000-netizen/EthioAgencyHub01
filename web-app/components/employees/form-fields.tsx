  ...
  return (
    <label className="flex flex-col gap-1 text-sm font-semibold text-slate-700 dark:text-slate-200">
      ...
      <select
        ...
        className="rounded-2xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-2 text-sm font-normal shadow-sm dark:shadow-soft-dark focus:border-brand-600 focus:outline-none"
      >
