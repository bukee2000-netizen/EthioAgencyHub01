...
export function InstitutionDetail() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-ink dark:text-ink-dark">Institution Details</h1>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 bg-gradient-to-br from-cyan-50 to-cyan-100/50">
          <p className="text-sm text-slate-600 dark:text-slate-300">Total Partners</p>
          <p className="mt-2 text-2xl font-bold text-cyan-600">56</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 bg-gradient-to-br from-teal-50 to-teal-100/50">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 bg-gradient-to-br from-blue-50 to-blue-100/50">
          <p className="text-sm text-slate-600 dark:text-slate-300">MOUs Signed</p>
          <p className="mt-2 text-2xl font-bold text-blue-600">42</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 bg-gradient-to-br from-sky-50 to-sky-100/50">
          <p className="text-sm text-slate-600 dark:text-slate-300">Contacts</p>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 overflow-hidden">
        <div className="border-b border-slate-200 dark:border-slate-700 px-6 py-4">
          <h3 className="text-lg font-bold text-ink dark:text-ink-dark">Partner Institutions</h3>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                ...
                <th className="px-6 py-3 text-left font-semibold text-slate-600 dark:text-slate-300">Country</th>
                <th className="px-6 py-3 text-left font-semibold text-slate-600 dark:text-slate-300">Contacts</th>
            ...
            <tbody className="divide-y divide-slate-100">
              {institutions.map((inst) => (
                <tr key={inst.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50">
                  <td className="px-6 py-4 font-semibold text-slate-700 dark:text-slate-200">{inst.name}</td>
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{inst.country}</td>
